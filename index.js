...
// **********************2***************************
const actors = films.concat.apply([], films.map(movie => movie.actors));
...
console.log(moviesByYear(films, 1977));
...
console.log(moviesByTitle(films, "Widow"));
...
console.log(moviesByTitleAndPlot(films, "Voldemort's"));
...
console.log(searchOfFilm(films, 'title', "Black Widow"));